...
exports.DiagramsModule = DiagramsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([diagram_entity_1.DiagramEntity])],
        controllers: [diagrams_controller_1.DiagramsController],
        providers: [diagrams_service_1.DiagramsService],
        exports: [diagrams_service_1.DiagramsService],
    })
], DiagramsModule);
